    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <h2 className="text-2xl md:text-3xl font-display font-semibold text-ink-900 dark:text-ink-50 mb-2">
              Распознать входящее письмо
            </h2>
            <p className="text-sm text-ink-700 dark:text-ink-400 max-w-2xl">
