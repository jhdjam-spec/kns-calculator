...
const steps = [
  {
    ...
    body: "Расход Q (м³/ч), напор, тип объекта. Если не знаете расход — встроенный помощник посчитает по числу квартир, гостиничных номеров или площади кровли.",
  },
  {
    n: "02",
    icon: Cpu,
    title: "Алгоритм считает",
    body: "Гидравлика по СП 32.13330, проверка по AOR/POR, фильтр по импеллеру и проходному сечению. Сравниваем 199 моделей в базе за миллисекунды.",
  },
  {
    n: "03",
    icon: FileText,
    title: "Получите спецификацию",
    body: "Топ-3 насоса в трёх ценовых сегментах с диапазоном цены комплекта (±10%). Опросник DOCX и BOM-черновик — для тендера или КП за 1 рабочий день.",
  },
];
