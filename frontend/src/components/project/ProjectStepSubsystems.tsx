...
const SUBSYSTEM_LABELS: Record<string, { title: string; description: string }> = {
  kns: {
    title: "КНС — канализационная насосная",
    description: "Отвод бытовых или промышленных стоков. Подбор насоса + корпус по СП 32.13330",
  },
  vns_potable: {
    title: "ВНС хозпитьевая — повышение давления",
    description: "Подача питьевой воды в здание / на территорию по СП 30/31",
  },
  vns_fire: {
    title: "ВНС пожарная — пожаротушение",
    description: "Расчёт расхода и резервуаров по СП 8.13130 (наружное) и СП 10.13130 (ВПВ)",
  },
  storm: {
    title: "Ливневая канализация",
    description: "Расход дождевой воды с территории по методу предельных интенсивностей СП 32 §6",
  },
  los: {
    title: "ЛОС — локальные очистные",
    description: "Биологическая очистка стоков перед сбросом. ПДК по ПП-728 / Приказ МСХ-552",
  },
  electrical: {
    title: "Электрика и шкаф управления",
    description: "Подбор кабеля, автомата, шкафа МИНИ/ОПТИ/МАКС по ПУЭ 7-е изд. + ТР ТС 004/020",
  },
  climate: {
    title: "Климат и глубина заложения",
    description: "Глубина прокладки трубы (промерзание), снеговая и ветровая нагрузка по СП 131/20",
  },
  structural: {
    title: "Прочность корпуса",
    description: "Пригруз бетоном при высоком УГВ, толщина стенки по ISO 9969 (SN-классы)",
  },
};
