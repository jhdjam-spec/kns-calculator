    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          onClick={onEdit}
          className="text-sm text-ink-400 hover:text-accent-500"
        >
          ← Изменить параметры
        </button>
      </div>
      ...
      <div className="rounded-xl border border-accent-500/30 bg-accent-500/5 p-6">
        <p className="text-sm text-ink-400 mb-2">Пиковый расход ливневых вод</p>
        <div className="flex items-baseline gap-3">
          <p className="text-4xl font-mono tabular-nums text-accent-500 font-semibold">
            {Q_r.toFixed(0)}
          </p>
          <p className="text-xl text-ink-300">л/с</p>
          <p className="text-sm text-ink-500">(≈ {Q_r_m3h} м³/час)</p>
        </div>
      ...
      <div className="rounded-md border border-amber-500/30 bg-amber-500/5 p-4 space-y-2">
        ...
        <ul className="text-xs text-ink-300 space-y-1 ml-2">
      ...
      {/* Внимание-плашка */}
      <div className="rounded-md border-2 border-amber-400 bg-amber-400/10 p-4 flex gap-3" role="alert">
      ...
      <div className="flex flex-wrap gap-3 pt-2">
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-md bg-accent-500 text-ink-950 font-medium hover:bg-accent-400 transition-colors"
        >
