...
> _«Каждая КНС — как картина: всё точно, ничего лишнего.»_
...
[![Author: INSERVO](https://img.shields.io/badge/Author-INSERVO%20Studio-orange.svg)](https://inservo.ru)
...
Можно использовать в коммерческих проектах при условии сохранения copyright-уведомления (это требование MIT).

Просьба к разработчикам производных работ:

- сохранять подпись авторства в footer веб-интерфейса и в метаданных PDF-документов;
- при существенных доработках указывать оригинальный источник.
...
По вопросам сотрудничества, кастомных доработок и интеграций:

- [inservo.ru](https://inservo.ru) — сайт студии
- zakaz@inservo.ru
- +7 (800) 222-44-57

## О студии

Калькулятор разработан и реализован **Студией интеграции умных решений Константина Морозова** (INSERVO Studio).

INSERVO — авторская студия инженерных и цифровых решений, специализирующаяся на:

- разработке инженерных калькуляторов и расчётных инструментов;
- интеграциях для производственных и проектных компаний;
- цифровизации процессов подбора и комплектации оборудования.

Партнёр производства: **ООО «Серво-Юг»** (Адыгея, Хатукай) — производитель КНС, ЛОС, СПД и резервуаров с 2009 года.
...
**Автор:** Константин Морозов · INSERVO Studio · [inservo.ru](https://inservo.ru)
