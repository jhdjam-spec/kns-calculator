...
SP_12_04 = Regulation(
    code="СП 12-104-2002",
    title="Безопасность труда в строительстве. Часть 4. Лестницы, площадки",
    edition="2002 (действует, частично замещён СП 49.13330)",
    in_force_from="2003-01-01",
    url_official="https://docs.cntd.ru/document/901833065",
    scope="Лестницы и переходные площадки внутри КНС",
