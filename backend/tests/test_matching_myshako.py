"""Эталонный верификационный тест: проект АртВинд Мысхако.

Шифр: АВ.1382.08.23-М-НК
Объект: Здание многофункционального использования, КН 23:47:0118055:4034, Новороссийск
Расход: 21.2 м³/ч (40 м³/сут / 5.9 л/с)
КНС: BloPlast PV-1590/3400 (H=15 м, P=3 кВт)
Насос: KAIQUAN 50WQ/S 20-22-3 (3 шт: 1 рабочий + 1 резервный + 1 на склад)
КПД: 46.4 % при Q=22.9, H=17.4

Алгоритм должен попадать в этот насос (или ±1 типоразмер) в сегменте 'budget'.
Если не попадает — пересматриваем веса composite_score.
"""
